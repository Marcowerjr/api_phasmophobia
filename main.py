...
@app.route('/api/add_ghost/', methods=['POST'])
def add_new_ghost():
...
@app.route('/api/ghost/update/<int:n_ghost>/', methods=['PUT'])
def update_ghost(n_top):
...
@app.route('/api/ghost/delete/<int:n_ghost>/', methods=['DELETE'])
